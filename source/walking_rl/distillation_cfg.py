...
@configclass
class WalkingRlDistillationStudentTeacherCfg:
...
@configclass
class WalkingRlDistillationStudentTeacherRecurrentCfg(WalkingRlDistillationStudentTeacherCfg):
...
@configclass
class WalkingRlDistillationAlgorithmCfg:
