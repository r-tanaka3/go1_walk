...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityCommandCfg(
        ...
        ranges=mdp.UniformVelocityCommandCfg.Ranges(
            lin_vel_x=(0.0, 0.5), lin_vel_y=(-0.05, 0.05), ang_vel_z=(-0.3, 0.3)
        ),
    )
@configclass
class ActionsCfg:
    ...
    joint_pos = mdp.JointPositionActionCustumScaleCfg(asset_name="robot", joint_names=[".*"], scale=0.5, use_default_offset=True)
...
class RewardsCfg:
    ...
    # joint_deviation_l1 -0.05 all joints
    pen_joint_deviation_2 = RewTerm(func=mdp.joint_deviation_l1, weight=-0.05, params={"asset_cfg": SceneEntityCfg("robot", joint_names=".*")})
